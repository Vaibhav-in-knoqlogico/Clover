...
import "./AwardClover.css";

function AwardClover() {
  const media = [
    { type: "video", src: "https://www.w3schools.com/html/mov_bbb.mp4" },
    { type: "image", src: "https://img.freepik.com/free-photo/winner-concept-with-prize-balloons_23-2149059637.jpg?w=1060" },
  ...
  return (
    <div className="clover-event-main">
      <div className="clover-event-main-top">
        <div className="clover-award-main-top-image">
        ...
        <div className="clover-event-hero-section-cards">
          <div className="clover-event-coursel-section">
            <div id="clover-event-coursel-event-name">
              <h3>Award Name Here</h3>
              <a href="#"><h6>Award detail Click here</h6></a>
            </div>
